...
import RatingComponent from '@/components/Shared/BaseRating.vue'
import CollectionToolbar from '@/views/Collection/components/CollectionToolbar.vue'
import CollectionStatistics from '@/views/Collection/components/CollectionStatistics.vue'
